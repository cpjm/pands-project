...
plt.savefig("histogram_frequency_veriscolor_sepal_width.png", format="png")
if display_plots_to_screen: plt.show()
plt.close()
...
plt.legend(title='Class of iris')
plt.legend(['Virginica'], fontsize = legend_fs)
plt.savefig("histogram_frequency_veriscolor_sepal_length.png", format="png")
if display_plots_to_screen: plt.show()
plt.close()
...
plt.legend(title='Class of iris')
plt.legend(['Virginica'], fontsize = legend_fs)
plt.savefig("histogram_frequency_veriscolor_petal_width.png", format="png")
if display_plots_to_screen: plt.show()
plt.close()
...
plt.legend(title='Class of iris')
plt.legend(['Virginica'], fontsize = legend_fs)
plt.savefig("histogram_frequency_veriscolor_petal_length.png", format="png")
if display_plots_to_screen: plt.show()
plt.close()
###################################################################################################
